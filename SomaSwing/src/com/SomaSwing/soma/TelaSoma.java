...
public class TelaSoma extends javax.swing.JFrame {
    ...
    private void btnSomaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSomaActionPerformed
        ...
        int n1 = Integer.parseInt(txtN1.getText()); /*Foi necessario a conversão nesse caso pois, getText retorna valores do tipo String*/
        int n2 = Integer.parseInt(txtN2.getText()); 
        int s = n1 + n2; 
        lblSoma.setText(Integer.toString(s)); /* Aqui foi necessario a conversão pois, setText retorna tipo String e antes o  valor "s" estava como inteiro*/
